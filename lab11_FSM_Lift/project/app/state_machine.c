...
#define TEXT_F0_SAFETY_PAUSE   "F0_SAFETY_PAUSE"
#define TEXT_F1_SAFETY_PAUSE   "F1_SAFETY_PAUSE"
    ...
    switch (state)
    {
        ...
        case F0_CLOSED:
            switch (event)
            {
                ...
                case EV_BUTTON_F1:
                    state = F1_SAFETY_PAUSE;
                    ah_door(DOOR_LOCK);                 
                    ah_show_state(TEXT_F1_SAFETY_PAUSE);
        ...
        case F1_CLOSED:
            switch (event)
            {
                ...
                case EV_BUTTON_F0:
                    state = F0_SAFETY_PAUSE;
                    ah_door(DOOR_LOCK);
                    ah_show_state(TEXT_F0_SAFETY_PAUSE);
                    timer_start(SAFETY_DURATION);
                    break;
